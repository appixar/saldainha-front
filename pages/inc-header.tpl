		...
		<div class="sidebar print:hidden">
			...
			<div class="main-sidebar">
				<div class="flex h-full w-full flex-col items-center border-r border-slate-150 bg-white dark:border-navy-700 dark:bg-navy-800">
					...
					<div class="flex pt-4">
						<a href="/chat">
							<img class="h-11 w-11 transition-transform duration-500 ease-in-out hover:rotate-[360deg]" src="https://saldanhainvest.com.br/logo3.png" alt="logo">
						</a>
					</div>
					...
					<div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
						<!-- Dashobards -->
						<a href="/chat" class="flex h-11 w-11 items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90" x-tooltip.placement.right="'IA'">
				...
				<div class="flex h-full grow flex-col bg-white pl-[var(--main-sidebar-width)] dark:bg-navy-750">
					...
					<div class="flex h-[calc(100%-4.5rem)] grow flex-col">
						<div>
							...
							<div class="swiper px-4 swiper-initialized swiper-horizontal" x-init="$nextTick(()=>$el._x_swiper= new Swiper($el,{  slidesPerView: 'auto', spaceBetween:10, slidesPerGroup:3}))">
								<div class="swiper-wrapper mt-1" id="swiper-wrapper-e10e4e102d410a9e67e" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
									<div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center swiper-slide-active" role="group" aria-label="1 / 18" style="margin-right: 10px;">
										<div class="h-11 w-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
											<img class="h-full w-full rounded-full border-2 border-white object-cover dark:border-slate-700" src="images/avatar/avatar-20.jpg" alt="avatar">
										</div>
										<p class="mt-1 w-14 break-words text-center text-xs text-slate-600 line-clamp-1 dark:text-navy-100">
											Konnor
										</p>
									</div>
									<div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center swiper-slide-next" role="group" aria-label="2 / 18" style="margin-right: 10px;">
										<div class="h-11 w-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
											<img class="h-full w-full rounded-full border-2 border-white object-cover dark:border-slate-700" src="images/avatar/avatar-4.jpg" alt="avatar">
										</div>
										<p class="mt-1 w-14 break-words text-center text-xs text-slate-600 line-clamp-1 dark:text-navy-100">
											Travis
										</p>
									</div>
									<div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center" role="group" aria-label="3 / 18" style="margin-right: 10px;">
										<div class="h-11 w-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
											<img class="h-full w-full rounded-full border-2 border-white object-cover dark:border-slate-700" src="images/avatar/avatar-19.jpg" alt="avatar">
										</div>
										<p class="mt-1 w-14 break-words text-center text-xs text-slate-600 line-clamp-1 dark:text-navy-100">
											Fuller
										</p>
									</div>
									<div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center" role="group" aria-label="4 / 18" style="margin-right: 10px;">
										<div class="h-11 w-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
											<img class="h-full w-full rounded-full border-2 border-white object-cover dark:border-slate-700" src="images/avatar/avatar-18.jpg" alt="avatar">
										</div>
										<p class="mt-1 w-14 break-words text-center text-xs text-slate-600 line-clamp-1 dark:text-navy-100">
											Alfredo
										</p>
									</div>
									<div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center" role="group" aria-label="5 / 18" style="margin-right: 10px;">
										<div class="h-11 w-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
											<img class="h-full w-full rounded-full border-2 border-white object-cover dark:border-slate-700" src="images/avatar/avatar-14.jpg" alt="avatar">
										</div>
										<p class="mt-1 w-14 break-words text-center text-xs text-slate-600 line-clamp-1 dark:text-navy-100">
											Elliott
										</p>
									</div>
									<div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center" role="group" aria-label="6 / 18" style="margin-right: 10px;">
										<div class="h-11 w-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
											<img class="h-full w-full rounded-full border-2 border-white object-cover dark:border-slate-700" src="images/avatar/avatar-13.jpg" alt="avatar">
										</div>
										<p class="mt-1 w-14 break-words text-center text-xs text-slate-600 line-clamp-1 dark:text-navy-100">
											Derrick
										</p>
									</div>
									<div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center" role="group" aria-label="7 / 18" style="margin-right: 10px;">
										<div class="h-11 w-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
											<img class="h-full w-full rounded-full border-2 border-white object-cover dark:border-slate-700" src="images/avatar/avatar-12.jpg" alt="avatar">
										</div>
										<p class="mt-1 w-14 break-words text-center text-xs text-slate-600 line-clamp-1 dark:text-navy-100">
											Simmons
										</p>
									</div>
									<div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center" role="group" aria-label="8 / 18" style="margin-right: 10px;">
										<div class="h-11 w-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
											<img class="h-full w-full rounded-full border-2 border-white object-cover dark:border-slate-700" src="images/avatar/avatar-11.jpg" alt="avatar">
										</div>
										<p class="mt-1 w-14 break-words text-center text-xs text-slate-600 line-clamp-1 dark:text-navy-100">
											Katrina
										</p>
									</div>
									<div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center" role="group" aria-label="9 / 18" style="margin-right: 10px;">
										<div class="h-11 w-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
											<img class="h-full w-full rounded-full border-2 border-white object-cover dark:border-slate-700" src="images/avatar/avatar-10.jpg" alt="avatar">
										</div>
										<p class="mt-1 w-14 break-words text-center text-xs text-slate-600 line-clamp-1 dark:text-navy-100">
											Henry
										</p>
									</div>
									<div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center" role="group" aria-label="10 / 18" style="margin-right: 10px;">
										<div class="h-11 w-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
											<img class="h-full w-full rounded-full border-2 border-white object-cover dark:border-slate-700" src="images/avatar/avatar-9.jpg" alt="avatar">
										</div>
										<p class="mt-1 w-14 break-words text-center text-xs text-slate-600 line-clamp-1 dark:text-navy-100">
											Curtis
										</p>
									</div>
									<div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center" role="group" aria-label="11 / 18" style="margin-right: 10px;">
										<div class="h-11 w-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
											<img class="h-full w-full rounded-full border-2 border-white object-cover dark:border-slate-700" src="images/avatar/avatar-8.jpg" alt="avatar">
										</div>
										<p class="mt-1 w-14 break-words text-center text-xs text-slate-600 line-clamp-1 dark:text-navy-100">
											Bradley
										</p>
									</div>
									<div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center" role="group" aria-label="12 / 18" style="margin-right: 10px;">
										<div class="h-11 w-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
											<img class="h-full w-full rounded-full border-2 border-white object-cover dark:border-slate-700" src="images/avatar/avatar-7.jpg" alt="avatar">
										</div>
										<p class="mt-1 w-14 break-words text-center text-xs text-slate-600 line-clamp-1 dark:text-navy-100">
											Samantha
										</p>
									</div>
									<div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center" role="group" aria-label="13 / 18" style="margin-right: 10px;">
										<div class="h-11 w-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
											<img class="h-full w-full rounded-full border-2 border-white object-cover dark:border-slate-700" src="images/avatar/avatar-6.jpg" alt="avatar">
										</div>
										<p class="mt-1 w-14 break-words text-center text-xs text-slate-600 line-clamp-1 dark:text-navy-100">
											Corey
										</p>
									</div>
									<div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center" role="group" aria-label="14 / 18" style="margin-right: 10px;">
										<div class="h-11 w-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
											<img class="h-full w-full rounded-full border-2 border-white object-cover dark:border-slate-700" src="images/avatar/avatar-5.jpg" alt="avatar">
										</div>
										<p class="mt-1 w-14 break-words text-center text-xs text-slate-600 line-clamp-1 dark:text-navy-100">
											Lance
										</p>
									</div>
									<div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center" role="group" aria-label="15 / 18" style="margin-right: 10px;">
										<div class="h-11 w-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
											<img class="h-full w-full rounded-full border-2 border-white object-cover dark:border-slate-700" src="images/avatar/avatar-4.jpg" alt="avatar">
										</div>
										<p class="mt-1 w-14 break-words text-center text-xs text-slate-600 line-clamp-1 dark:text-navy-100">
									...
									<div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center" role="group" aria-label="16 / 18" style="margin-right: 10px;">
										<div class="h-11 w-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
											<img class="h-full w-full rounded-full border-2 border-white object-cover dark:border-slate-700" src="images/avatar/avatar-3.jpg" alt="avatar">
										</div>
										<p class="mt-1 w-14 break-words text-center text-xs text-slate-600 line-clamp-1 dark:text-navy-100">
											Jensen
										</p>
									</div>
									<div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center" role="group" aria-label="17 / 18" style="margin-right: 10px;">
										<div class="h-11 w-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
											<img class="h-full w-full rounded-full border-2 border-white object-cover dark:border-slate-700" src="images/avatar/avatar-2.jpg" alt="avatar">
										</div>
										<p class="mt-1 w-14 break-words text-center text-xs text-slate-600 line-clamp-1 dark:text-navy-100">
											Perkins
										</p>
									</div>
									<div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center" role="group" aria-label="18 / 18" style="margin-right: 10px;">
										<div class="h-11 w-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
											<img class="h-full w-full rounded-full border-2 border-white object-cover dark:border-slate-700" src="images/avatar/avatar-1.jpg" alt="avatar">
										</div>
										<p class="mt-1 w-14 break-words text-center text-xs text-slate-600 line-clamp-1 dark:text-navy-100">
											Evans
										</p>
						...
						<div class="is-scrollbar-hidden mt-3 flex grow flex-col overflow-y-auto">
							<div @click="$dispatch('change-active-chat',{chatId:'chat-1',avatar_url:'images/avatar/avatar-19.jpg',name:'Alfredo Elliott'})" class="flex cursor-pointer items-center space-x-2.5 px-4 py-2.5 font-inter hover:bg-slate-150 dark:hover:bg-navy-600">
							...
							<div @click="$dispatch('change-active-chat',{chatId:'chat-2',avatar_url:'images/avatar/avatar-20.jpg',name:'Konnor Guzman'})" class="flex cursor-pointer items-center space-x-2.5 px-4 py-2.5 font-inter hover:bg-slate-150 dark:hover:bg-navy-600">
								<div class="avatar h-10 w-10">
							...
							<div @click="$dispatch('change-active-chat',{chatId:'chat-3',avatar_url:'images/avatar/avatar-18.jpg',name:'Travis Fuller'})" class="flex cursor-pointer items-center space-x-2.5 px-4 py-2.5 font-inter hover:bg-slate-150 dark:hover:bg-navy-600">
								<div class="avatar h-10 w-10">
								...
								<div class="flex flex-1 flex-col">
									...
									<div class="mt-1 flex items-center justify-between space-x-1">
										...
										<div class="flex h-4.5 min-w-[1.125rem] items-center justify-center rounded-full bg-primary px-1.5 text-tiny+ font-medium leading-none text-white dark:bg-accent">
											4
										</div>
									</div>
								</div>
							</div>
							<div @click="$dispatch('change-active-chat',{chatId:'chat-1',avatar_url:'images/avatar/avatar-14.jpg',name:'Derrick Simmons'})" class="flex cursor-pointer items-center space-x-2.5 px-4 py-2.5 font-inter hover:bg-slate-150 dark:hover:bg-navy-600">
								<div class="avatar h-10 w-10">
							...
							<div @click="$dispatch('change-active-chat',{chatId:'chat-2',avatar_url:'images/avatar/avatar-11.jpg',name:'Katrina West'})" class="flex cursor-pointer items-center space-x-2.5 px-4 py-2.5 font-inter hover:bg-slate-150 dark:hover:bg-navy-600">
								<div class="avatar h-10 w-10">
							...
							<div @click="$dispatch('change-active-chat',{chatId:'chat-3',avatar_url:'images/avatar/avatar-13.jpg',name:'Corey Evans'})" class="flex cursor-pointer items-center space-x-2.5 px-4 py-2.5 font-inter hover:bg-slate-150 dark:hover:bg-navy-600">
								<div class="avatar h-10 w-10">
							...
							<div @click="$dispatch('change-active-chat',{chatId:'chat-1',avatar_url:'images/avatar/avatar-10.jpg',name:'Anthony Jensen'})" class="flex cursor-pointer items-center space-x-2.5 px-4 py-2.5 font-inter hover:bg-slate-150 dark:hover:bg-navy-600">
								<div class="avatar h-10 w-10">
							...
							<div @click="$dispatch('change-active-chat',{chatId:'chat-2',avatar_url:'images/avatar/avatar-12.jpg',name:'Lance Tucker'})" class="flex cursor-pointer items-center space-x-2.5 px-4 py-2.5 font-inter hover:bg-slate-150 dark:hover:bg-navy-600">
								<div class="avatar h-10 w-10">
						...
						<div class="flex h-12 shrink-0 justify-between border-t border-slate-150 px-1.5 py-1 dark:border-navy-600">
							<a href="apps-chat.html#" x-tooltip="'All Chats'" class="btn h-9 w-9 rounded-full p-0 text-primary hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:text-accent dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
								<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
									<path d="M2 5a2 2 0 012-2h7a2 2 0 012 2v4a2 2 0 01-2 2H9l-3 3v-3H4a2 2 0 01-2-2V5z"></path>
									<path d="M15 7v2a4 4 0 01-4 4H9.828l-1.766 1.767c.28.149.599.233.938.233h2l3 3v-3h2a2 2 0 002-2V9a2 2 0 00-2-2h-1z"></path>
								</svg>
							</a>
							<a href="apps-chat.html#" x-tooltip="'Users'" class="btn h-9 w-9 rounded-full p-0 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:hover:text-accent dark:focus:bg-navy-300/20 dark:focus:text-accent dark:active:bg-navy-300/25">
								<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
									<path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
								</svg>
							</a>

							<a href="apps-chat.html#" x-tooltip="'Groups'" class="btn h-9 w-9 rounded-full p-0 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:hover:text-accent dark:focus:bg-navy-300/20 dark:focus:text-accent dark:active:bg-navy-300/25">
								<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
									<path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
								</svg>
							</a>
							<a href="apps-chat.html#" x-tooltip="'Channels'" class="btn h-9 w-9 rounded-full p-0 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:hover:text-accent dark:focus:bg-navy-300/20 dark:focus:text-accent dark:active:bg-navy-300/25">
								<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
									<path stroke-linecap="round" stroke-linejoin="round" d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14"></path>
								</svg>
							</a>

							<a href="apps-chat.html#" x-tooltip="'More'" class="btn h-9 w-9 rounded-full p-0 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:hover:text-accent dark:focus:bg-navy-300/20 dark:focus:text-accent dark:active:bg-navy-300/25">
								<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
				...
				<div class="flex h-full flex-col bg-white dark:bg-navy-750">
					<div class="flex h-18 shrink-0 items-center justify-center">
						<div class="avatar flex h-10 w-10">
							<div class="is-initial is-initial rounded-full bg-primary/10 text-primary dark:bg-accent-light/10 dark:text-accent-light">
					...
					<div class="flex h-[calc(100%-4.5rem)] grow flex-col">
						<div class="is-scrollbar-hidden flex grow flex-col overflow-y-auto">
							<ul class="mt-2 flex flex-col items-center justify-center space-y-1">
								<li>
									<a href="apps-chat.html#" class="btn h-10 w-10 p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
							...
							<div class="flex flex-col">
								<div @click="$dispatch('change-active-chat',{chatId:'chat-1',avatar_url:'images/avatar/avatar-19.jpg',name:'Alfredo Elliott'})" class="flex cursor-pointer items-center justify-center py-2.5 hover:bg-slate-150 dark:hover:bg-navy-600">
									<div class="avatar h-10 w-10">
										<img class="rounded-full" src="images/avatar/avatar-19.jpg" alt="avatar">
										<div class="absolute right-0 h-3 w-3 rounded-full border-2 border-white bg-slate-300 dark:border-navy-700"></div>
									</div>
								</div>
								<div @click="$dispatch('change-active-chat',{chatId:'chat-2',avatar_url:'images/avatar/avatar-20.jpg',name:'Konnor Guzman'})" class="flex cursor-pointer items-center justify-center py-2.5 hover:bg-slate-150 dark:hover:bg-navy-600">
									<div class="avatar h-10 w-10">
										<img class="rounded-full" src="images/avatar/avatar-20.jpg" alt="avatar">
									</div>
								</div>
								<div @click="$dispatch('change-active-chat',{chatId:'chat-3',avatar_url:'images/avatar/avatar-18.jpg',name:'Travis Fuller'})" class="flex cursor-pointer items-center justify-center py-2.5 hover:bg-slate-150 dark:hover:bg-navy-600">
									<div class="avatar h-10 w-10">
										<img class="rounded-full" src="images/avatar/avatar-18.jpg" alt="avatar">
								...
								<div @click="$dispatch('change-active-chat',{chatId:'chat-1',avatar_url:'images/avatar/avatar-14.jpg',name:'Derrick Simmons'})" class="flex cursor-pointer items-center justify-center py-2.5 hover:bg-slate-150 dark:hover:bg-navy-600">
									<div class="avatar h-10 w-10">
										<img class="rounded-full" src="images/avatar/avatar-14.jpg" alt="avatar">
										<div class="absolute right-0 h-3 w-3 rounded-full border-2 border-white bg-slate-300 dark:border-navy-700"></div>
									</div>
								</div>
								<div @click="$dispatch('change-active-chat',{chatId:'chat-2',avatar_url:'images/avatar/avatar-11.jpg',name:'Katrina West'})" class="flex cursor-pointer items-center justify-center py-2.5 hover:bg-slate-150 dark:hover:bg-navy-600">
									<div class="avatar h-10 w-10">
										<img class="rounded-full" src="images/avatar/avatar-11.jpg" alt="avatar">
										<div class="absolute right-0 h-3 w-3 rounded-full border-2 border-white bg-slate-300 dark:border-navy-700"></div>
									</div>
								</div>
								<div @click="$dispatch('change-active-chat',{chatId:'chat-3',avatar_url:'images/avatar/avatar-13.jpg',name:'Corey Evans'})" class="flex cursor-pointer items-center justify-center py-2.5 hover:bg-slate-150 dark:hover:bg-navy-600">
									<div class="avatar h-10 w-10">
										<img class="rounded-full" src="images/avatar/avatar-13.jpg" alt="avatar">
									</div>
								</div>
								<div @click="$dispatch('change-active-chat',{chatId:'chat-1',avatar_url:'images/avatar/avatar-10.jpg',name:'Anthony Jensen'})" class="flex cursor-pointer items-center justify-center py-2.5 hover:bg-slate-150 dark:hover:bg-navy-600">
									<div class="avatar h-10 w-10">
										<img class="rounded-full" src="images/avatar/avatar-10.jpg" alt="avatar">
									</div>
								</div>
								<div @click="$dispatch('change-active-chat',{chatId:'chat-2',avatar_url:'images/avatar/avatar-12.jpg',name:'Lance Tucker'})" class="flex cursor-pointer items-center justify-center py-2.5 hover:bg-slate-150 dark:hover:bg-navy-600">
									<div class="avatar h-10 w-10">
										<img class="rounded-full" src="images/avatar/avatar-12.jpg" alt="avatar">
									</div>
								</div>
						...
						<div class="flex flex-col items-center justify-center py-3">
							<div x-data="usePopper({placement:'right-start',offset:4})" @click.outside="isShowPopper &amp;&amp; (isShowPopper = false)" class="inline-flex">
								<button x-ref="popperRef" @click="isShowPopper = !isShowPopper" class="btn h-10 w-10 rounded-full border border-slate-200 p-0 font-medium hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-500 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90">
								...
								<template x-teleport="#x-teleport-target">
									<div x-ref="popperRoot" class="popper-root" :class="isShowPopper &amp;&amp; 'show'">
										<div class="popper-box rounded-md border border-slate-150 bg-white py-1.5 font-inter dark:border-navy-500 dark:bg-navy-700">
											<ul>
												<li>
													<a href="apps-chat.html#" class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Action</a>
												</li>
												<li>
													<a href="apps-chat.html#" class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Another Action</a>
												</li>
												<li>
													<a href="apps-chat.html#" class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Something else</a>
												</li>
											</ul>
											<div class="my-1 h-px bg-slate-150 dark:bg-navy-500"></div>
											<ul>
												<li>
													<a href="apps-chat.html#" class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Separated Link</a>
												</li>
											</ul>
										</div>
									</div>
					...
					<div x-show="activeTab === 'tabHome'" x-transition:enter="transition-all duration-500 easy-in-out" x-transition:enter-start="opacity-0 [transform:translate3d(0,1rem,0)]" x-transition:enter-end="opacity-100 [transform:translate3d(0,0,0)]" class="is-scrollbar-hidden overflow-y-auto overscroll-contain pt-1">
						...
						<div class="mt-3">
							...
							<div class="swiper mt-3 px-3 swiper-initialized swiper-horizontal" x-init="$nextTick(()=>new Swiper($el,{  slidesPerView: 'auto', spaceBetween: 16}))">
								<div class="swiper-wrapper" style="transition-duration: 0ms;" id="swiper-wrapper-3ca92cbd498b77f7" aria-live="polite">
						...
						<div class="mt-4 px-3">
							...
							<div class="mt-3 flex space-x-3">
								...
								<a href="https://lineone.piniastudio.com/dashboards-sales.html" class="w-12 text-center">
									<div class="avatar h-10 w-10">
							...
							<div class="mt-3 grid grid-cols-2 gap-3 px-3">
								<div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
									...
									<div class="ax-transparent-gridline">
										<div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.stockMarket1); $el._x_chart.render() });" style="min-height: 100px;">
											<div id="apexcharts7xphgj0w" class="apexcharts-canvas apexcharts7xphgj0w" style="width: 0px; height: 100px;"><svg id="SvgjsSvg1022" width="0" height="100" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev" class="apexcharts-svg" xmlns:data="ApexChartsNS" transform="translate(0, 0)" style="background: transparent;">
													<g id="SvgjsG1025" class="apexcharts-annotations"></g>
													<g id="SvgjsG1024" class="apexcharts-inner apexcharts-graphical">
								...
								<div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
									...
									<div class="ax-transparent-gridline">
										<div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.stockMarket2); $el._x_chart.render() });" style="min-height: 100px;">
											<div id="apexcharts6ttrff1y" class="apexcharts-canvas apexcharts6ttrff1y" style="width: 0px; height: 100px;"><svg id="SvgjsSvg1026" width="0" height="100" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev" class="apexcharts-svg" xmlns:data="ApexChartsNS" transform="translate(0, 0)" style="background: transparent;">
													<g id="SvgjsG1029" class="apexcharts-annotations"></g>
													<g id="SvgjsG1028" class="apexcharts-inner apexcharts-graphical">
						...
						<div class="mt-4">
							...
							<div class="mt-3 space-y-3 px-2">
								<div class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
									<div class="flex flex-1 flex-col justify-between">
										<div class="line-clamp-2">
											<a href="apps-chat.html#" class="font-medium text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">What is Tailwind CSS?</a>
										</div>
								...
								<div class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
									<div class="flex flex-1 flex-col justify-between">
										<div class="line-clamp-2">
											<a href="apps-chat.html#" class="font-medium text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">Tailwind CSS Card Example</a>
										</div>
										<div class="flex items-center justify-between">
											<div class="flex items-center space-x-2">
												<div class="avatar h-7 w-7">
								...
								<div class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
									<div class="flex flex-1 flex-col justify-between">
										<div class="line-clamp-2">
											<a href="apps-chat.html#" class="font-medium text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">10 Tips for Making a Good Camera Even Better</a>
										</div>
										<div class="flex items-center justify-between">
											<div class="flex items-center space-x-2">
												<div class="avatar h-7 w-7">
						...
						<div class="mt-3 px-3">
							<div class="rounded-lg bg-slate-100 p-3 dark:bg-navy-600">
								<div class="flex items-center justify-between">
									...
									<a href="apps-chat.html#" class="text-xs+ font-medium text-primary outline-none transition-colors duration-300 hover:text-primary/70 focus:text-primary/70 dark:text-accent-light dark:hover:text-accent-light/70 dark:focus:text-accent-light/70">Upgrade</a>
								</div>
						...
						<ol class="timeline line-space mt-5 px-4 [--size:1.5rem]">
							...
							<li class="timeline-item">
								...
								<div class="timeline-item-content flex-1 pl-4">
									...
									<div class="mt-4">
										...
										<a href="apps-chat.html#" class="text-xs text-primary hover:text-primary-focus dark:text-accent-light dark:hover:text-accent">
											#Tag
										</a>
							...
							<li class="timeline-item">
								...
								<div class="timeline-item-content flex-1 pl-4">
									...
									<a href="apps-chat.html#" class="inline-flex items-center space-x-1 pt-2 text-slate-600 transition-colors hover:text-primary dark:text-navy-100 dark:hover:text-accent">
										<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
									...
									<div class="pt-2">
										<a href="apps-chat.html#" class="tag rounded-full border border-secondary/30 bg-secondary/10 text-secondary hover:bg-secondary/20 focus:bg-secondary/20 active:bg-secondary/25 dark:border-secondary-light/30 dark:bg-secondary-light/10 dark:text-secondary-light dark:hover:bg-secondary-light/20 dark:focus:bg-secondary-light/20 dark:active:bg-secondary-light/25">
											UI/UX
										</a>

										<a href="apps-chat.html#" class="tag rounded-full border border-info/30 bg-info/10 text-info hover:bg-info/20 focus:bg-info/20 active:bg-info/25">
											CRM
										</a>

										<a href="apps-chat.html#" class="tag rounded-full border border-success/30 bg-success/10 text-success hover:bg-success/20 focus:bg-success/20 active:bg-success/25">
											Dashboard
										</a>
									</div>
								</div>
